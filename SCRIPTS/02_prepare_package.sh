...
sed -i 's,rk322xh_bl31_v1.49.elf,rk3328_bl31.elf,g' package/boot/uboot-rockchip/Makefile
sed -i 's,rk3399_bl31_v1.35.elf,rk3399_bl31.elf,g' package/boot/uboot-rockchip/Makefile
